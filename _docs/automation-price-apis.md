...
Turing RPC (Kusama): Coming in Q4!
...
2. **Enable users to authorize future transactions powered by OAK** using a proxy pallet and XCM origin converter.
    ...
    Proxy pallet: https://github.com/OAK-Foundation/substrate-parachain-template/pull/12
    
    XCM converter: https://github.com/OAK-Foundation/substrate-parachain-template/pull/14
