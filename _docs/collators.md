...
| Inflation `parachainStaking.inflationConfig`                                | 5.00% |
...
console.log(`Reduction of self-delegation bond duration: ${revokeDelegationDelay}`);
...
To increase your chances of community members [staking](../delegator) to your collator, we recommend you setup an [on-chain identity](../identity). 
